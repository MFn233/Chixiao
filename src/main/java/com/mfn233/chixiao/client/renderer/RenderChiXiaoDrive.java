package com.mfn233.chixiao.client.renderer;
...
public class RenderChiXiaoDrive extends Render {
    ...
    public RenderChiXiaoDrive(RenderManager renderManager) {
        super(renderManager);
    }

    @Override
    public void doRender(Entity entity, double d0, double d1, double d2, float f, float f1) {
        if (entity instanceof ChixiaoDrive) {
            doDriveRender((ChixiaoDrive) entity, d0, d1, d2, f, f1);
        }
    }
    ...
    private void doDriveRender(ChixiaoDrive entityDrive, double dX, double dY, double dZ, float f, float f1) {
